...
const Tech = () => {
  return (
    <>
    <p style={{marginBottom:"20px",marginTop:"30px",marginLeft:"660px",fontWeight:"600",width:"170px",fontSize:"30px",borderBottom:"5px solid #f3a342"}}>TECH NEWS</p>
    <div>
        {
          data.india.map(item =>
            <Techpage key={item.id} {...item}/>
            )
        }
      </div>
      </>
