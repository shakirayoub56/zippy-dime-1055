...
const Entertainment = () => {
  ...
  return (
    <>
    <p style={{marginBottom:"20px",marginTop:"30px",marginLeft:"660px",fontWeight:"600",width:"340px",fontSize:"30px",borderBottom:"5px solid #f3a342"}}>ENTERTAINMENT NEWS</p>
    <div>
        {
          data.india.map(item =>
            <Entertainmentpage key={item.id} {...item}/>
            )
        }
      </div>
      </>
