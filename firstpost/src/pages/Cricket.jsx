...
const Cricket = () => {
  return (
    <>
    <p style={{marginBottom:"20px",marginTop:"30px",marginLeft:"660px",fontWeight:"600",width:"210px",fontSize:"30px",borderBottom:"5px solid #f3a342"}}>CRICKET NEWS</p>
    <div>
        {
          data.india.map(item =>
            <Cricketpage key={item.id} {...item}/>
            )
        }
      </div>
      </>
