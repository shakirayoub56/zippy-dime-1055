...
function Footer() {
  return (
    ...
    <div style={{width: '100%', height: "5px",backgroundColor:"gray",marginTop: "-100px"}}></div>
      ...
      <img style={{width:"116px" ,height:"33px"}} 
      ...
      <div style={{display:"flex",fontSize:"15px",fontWeight:"lighter",gap:"30px"}}>
              <div id="sp">
                <label style={{fontWeight:"bold",paddingRight:"10px"}}>Network18 sites   </label>
                <span><i class="fa-solid fa-greater-than"></i></span>
                </div>
                
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}} ><p>Moneycontrol</p></div>
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}}><p>News18</p></div>
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}}><p>CNBC TV18</p></div>
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}}><p>Overdrive</p></div>
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}}><p>Forbes India</p></div>
               <div style={{color:"#33333", font: "400 12px/22px Arial", cursor:"pointer"}}><p>TopperLearning</p></div> 
                
        </div>
      </div>

      <div style={{textAlign:"center",color:"#33333", font: "400 12px/22px Arial"}}>
